...
import 'package:product_explorer/features/cart_screen/service/cart_service.dart';
...
void main() {
  ...
  test(
    'CartService adds products to cart and calculates subtotal/total',
    () async {
  ...
  test('CartService persists cart across re-initialization', () async {
    ...
    expect(
      CartService.instance.items.first.product.title,
