...
import 'package:product_explorer/features/home_screen/model/product_model.dart';
...
void main() {
  ...
  test(
    'FavoritesService adds product to favorites and persists locally',
    () async {
      ...
      expect(
        FavoritesService.instance.favorites.first.title,
